...
define(["parse/parse", "stream/stream"], function(parse, stream) {
    ...
    var letterParser = tokenParser(regExpTest.bind(), "any letter character");
    var spaceParser = tokenParser(regExpTest.bind(), "any space character");
    var digitParser = tokenParser(regExpTest.bind(), "any digit character");
    return {
