...
define(["require", "exports", "parse/parse", "nu/stream"], (function(require, exports, __o, stream) {
    ...
    var __o = __o,
        ...
        rest = stream["rest"]; {
            ...
            var Session = (function(done, state, k, chunks) {
                (this.done = done);
                (this.state = state);
                (this.k = k);
                (this.chunks = chunks);
            ...
            (Session.prototype.addChunk = (function(c) {
                return new(Session)(this.done, this.state, this.k, this.chunks.concat(c));
            }));
            ...
            (provide = (function(r, c) {
                ...
                while ((result instanceof Request)) {
                    if (!r2.hasChunk(result.chunk)) return new(Session)(false, result.state, (function(x) {
            ...
            (finish = (function(r) {
                return (!r.done ? finish(trampoline(r.k(r.state))) : r.k());
            }));
            (parseIncState = (function(p, state, ok, err) {
                return (function() {
                    {
                        var pok = (function(x, s) {
                            return new(Session)(true, s, ok.bind(null, x, s));
                        }),
                            perr = (function(x, s) {
                                return new(Session)(true, s, err.bind(null, x, s));
                            }); {
                                return (state.isEmpty() ? new(Session)(false, new(IncrementalState)(0, state), (function(s) {
                                    return parseState(p, s, pok, perr);
