 ...
 */
var anyCharParser = constant(tokenParser(regExpTest.bind(/^.$/)));

/**
 * Parser that consumes any letter character.
 * 
 */
var letterParser = constant(tokenParser(regExpTest.bind(/^[a-z]$/i)));

/**
 * Parser that consumes any space character.
 * 
 */
var spaceParser = constant(tokenParser(regExpTest.bind(/^\s$/i)));


/**
 * Parser that consumes any number character.
 */
var digitParser = constant(tokenParser(regExpTest.bind(/^[0-9]$/i)));
