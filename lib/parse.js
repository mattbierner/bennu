 ...
 */
var Position = function(line, column) {
    this.line = line;
    this.column = column;
};
...
var bindParser = function(p, f) {
    return function BIND_PARSER(state, m, cok, cerr, eok, eerr) {
        var pcok = function(x, state, m) { return cont(f(x, state), [state, m, cok, cerr, cok, cerr]); },
            peok = function(x, state, m) { return cont(f(x, state), [state, m, cok, cerr, eok, eerr]); };
...
var backtrackParser = function(p) {
    return function(state, m, cok, cerr, eok, eerr) {
        var pcok = function(x, state /*, _*/) { return cok(x, state, m); },
            ...
            peok = function(x, state /*, _*/) { return eok(x, state, m); },
            peerr = function(x, state /*, _*/) { return eerr(x, state, m); };
...
var memoParser = function(p) {
    ...
    return function(state, m, cok, cerr, eok, eerr) {
        ...
        var pcok = function(x, pstate, pm) {
            var entry = function(_, m, cok /*, cerr, eok, eerr*/) { return cok(x, pstate, m); };
            return cok(x, pstate, Memoer.update(pm, id, entry, state));
        };
        var pcerr = function(x, pstate, pm) {
            var entry = function(_, m, cok, cerr /*, eok, eerr*/) { return cerr(x, pstate, m); };
            return cerr(x, pstate, Memoer.update(pm, id, entry, state));
        };
        var peok = function(x, pstate, pm) {
            var entry = function(_, m, cok, cerr, eok /*, eerr*/) { return eok(x, pstate, m); };
            return eok(x, pstate, Memoer.update(pm, id, entry, state));
        };
        var peerr = function(x, pstate, pm) {
            var entry = function(_, m, cok, cerr, eok, eerr) { return eerr(x, pstate, pm); };
...
var runStream = function(p, s) {
    return runState(p, new InputState(s, new Position(1, 0)));
};
...
var runManyState = function(p, state) {
    var manyP = _optionalValueParser(
        bindParser(p, function(x, state, m) {
...
var runManyStream = function(p, s) {
    return runManyState(p, new InputState(s, new Position(1, 0)));
};
...
var testStream = function(p, s) {
    return testState(p, new InputState(s, new Position(1, 0)));
};
