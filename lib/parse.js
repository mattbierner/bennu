...
var asStream = function(s) {
    return (!s || s.length < 1 ? null : {
        'first':  function() { return s[0]; },
        'rest': function() { return asStream(slice.call(s, 1)); }
    });
};
 ...
 * 
 */
var runStream = compose(function(v) { return v()(); }, function(p, input) {
