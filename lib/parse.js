/*
 * THIS FILE IS AUTO GENERATED from '/Users/mattbierner/Projects/js/parse/lib/parse.kep'
 * DO NOT EDIT
*/
define(["stream/stream"], function(stream) {
    ...
    var concatParser = curry(_joinParser, stream.concat);
