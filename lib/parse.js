...
define(["require", "exports", "nu/stream", "seshat"], (function(require, exports, stream, seshat) {
    "use strict";
    var ParserError, ParseError, MultipleError, UnknownError, UnexpectError, ExpectError, ParserState, Position, rec, Parser, RecParser, always, never, bind, eof, extract, getParserState, setParserState, modifyParserState, getState, setState, modifyState, getInput, setInput, getPosition, setPosition, fail, attempt, lookahead, next, sequencea, sequence, either, choicea, choice, optional, expected, eager, binds, cons, append, enumerationa, enumeration, many, many1, token, anyToken, memo, Memoer, exec, parseState, parseStream, parse, runState, runStream, run, runManyState, runManyStream, runMany, testState, testStream, test;
    var stream = stream,
        NIL = stream["end"],
        first = stream["first"],
