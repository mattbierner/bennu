...
define(["nu/stream"], function(stream) {
    ...
    var runState = function(p, state) {
        return exec(p, state, null, constant, throwConstant, constant, throwConstant);
    }
    ;
    ...
    ;
    var testState = function(p, state) {
        return _perform(p, state, constant(constant(true)), constant(constant(false)));
    }
    ;
