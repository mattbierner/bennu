...
define(["nu/stream"], function(stream) {
    ...
    var append = curry(_joinParser, stream.append);
    ...
    ();
    var anyToken = token(constant(true));
    ...
    var runStream = function(p, s) {
        return runState(p, new ParserState(s, new Position(0), null));
    }
    ;
    ...
    var runManyStream = function(p, s) {
        return runManyState(p, new ParserState(s, new Position(0), null));
    }
    ;
    ...
    var testStream = function(p, s) {
        return testState(p, new ParserState(s, new Position(0), null));
    }
    ;
