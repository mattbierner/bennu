...
var runParser = (function(){
    ...
    var Err = function(err /*, ...*/) {
        return function() {
            throw err.apply(undefined, slice.call(arguments, 1));
        };
    };
...
var testParser = (function(){
    ...
    var Err = constant(constant(false));
    return function(p, state) {
        return trampoline(p(state, Ok, Err, Ok, Err))()();
    };
}());
...
var neverParser = constant(function(state, cok, cerr, eok, eerr) {
    return eerr(make(UnknownError, state.pos), state);
});
...
var eofParser = constant(function(state, cok, cerr, eok, eerr) {
    return (!state.input ?
        eok(null, state) :
        eerr(make(ExpectError, state.pos, "end of input")));
});
