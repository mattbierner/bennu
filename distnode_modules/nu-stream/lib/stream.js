/*
 * THIS FILE IS AUTO GENERATED FROM 'node_modules/nu-stream/lib/stream.kep'
 * DO NOT EDIT
*/
define(["require", "exports"], (function(require, exports) {
    ...
    var count = (function(n) {
        ...
        f;
    (indexed = zip.bind(null, ((f = (function() {
        return count(1);
    })), ({
        first: 0,
        rest: f
    ...
    (map = (function(f0, s) {
        var val, f1, f2;
        return ((null === s) ? s : ((val = f0(s.first)), (f1 = (function() {
            return map(f0, s.rest());
        })), (f2 = memo(f1)), ({
            first: val,
            rest: f2
        })));
    ...
    (filter = (function(pred, s) {
        ...
        for (var head = s;
            ...
            var x = head,
                x0 = x.first;
            if (pred(x0)) {
                var f0 = (function(filter, rest, pred, head) {
                    return (function() {
                        var s1;
