define(['parse/parse'], function(parse){
    ...
    return {
        ...
        'tests': [
            ["Consume Times items",
            function(){
                var a = parse.eager(parse.times(3, parse.character('a')));
            ...
            ["Consume Zero items",
             function(){
                 var a = parse.eager(parse.times(0, parse.character('a')));
            ...
            function(){
             ...
             ["Consume non string",
             function(){
                 var abPairs = parse.eager(parse.times(3, parse.character('ab')));
              ...
              ["Consume large input many",
               function(){
                   var a = parse.eager(parse.times(1000, parse.character('a')));
