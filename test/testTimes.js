define(['parse/parse', 'parse/parse_lang'], function(parse, parse_lang){
    ...
    return {
        ...
        'tests': [
            ["Consume Times items",
            function(){
                var a = parse.eager(parse_lang.times(3, parse.character('a')));
            ...
            ["Consume Zero items",
             function(){
                 var a = parse.eager(parse_lang.times(0, parse.character('a')));
            ...
            function(){
             ...
             ["Consume non string",
             function(){
                 var abPairs = parse.eager(parse_lang.times(3, parse.character('ab')));
              ...
              ["Consume large input many",
               function(){
                   var a = parse.eager(parse_lang.times(1000, parse.character('a')));
