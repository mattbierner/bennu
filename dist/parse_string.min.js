...
m=function(b,a){return b[a]=b[a]||{}},n=function(a,d){g(d,m,a)[""]=null;return a},l=function(b,d){var e=[];Object.keys(b).forEach(function(c){1===c.length&&e.push(a.next(i(c),l(b[c],d+c)))});b.hasOwnProperty("")&&e.push(a.always(d));return a.choice.apply(void 0,e)},p=a.Parser("Any Character",a.token(c.bind(/^.$/),f("any character"))),q=a.Parser("Any Letter",a.token(c.bind(/^[a-z]$/i),f("any letter character"))),r=a.Parser("Any Whitespace",a.token(c.bind(/^\s$/i),f("any space character"))),c=a.Parser("Any Digit",
a.token(c.bind(/^[0-9]$/i),f("any digit character")));return{character:i,string:function(b){return a.bind(a.getPosition(),function(c){return a.attempt(k(b,b,"",c))})},trie:function(b){return a.attempt(l(g(b,n,{}),""))},anyChar:p,letter:q,space:r,digit:c}});
