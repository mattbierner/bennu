...
l=function(a,c){a[c]=a[c]||{};return a[c]},m=function(a,c){h(c,l,a)[""]=null;return a},n=function c(b,g){return a.choice.apply(void 0,Object.keys(b).sort().reverse().map(function(f){return 0===f.length?a.always(g):a.attempt(a.next(j(f),c(b[f],g+f)))}))},p=a.Parser("Any Character",a.token(b.bind(/^.$/),e("any character"))),q=a.Parser("Any Letter",a.token(b.bind(/^[a-z]$/i),e("any letter character"))),r=a.Parser("Any Whitespace",a.token(b.bind(/^\s$/i),e("any space character"))),b=a.Parser("Any Digit",
a.token(b.bind(/^[0-9]$/i),e("any digit character")));return{character:j,string:function(b){return a.bind(a.getPosition(),function(e){return a.attempt(k(b,b,"",e))})},trie:function(b){return a.attempt(n(h(b,m,{}),""))},anyChar:p,letter:q,space:r,digit:b}});
