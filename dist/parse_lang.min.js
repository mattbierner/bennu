...
sepEndBy:function(a,c){return b.either(k(a,c),b.next(b.optional(e.end,a),b.always(e.end)))},endBy1:function(a,c){return b.many1(f(c,a))},endBy:function(a,c){return b.many(f(c,a))},chainl1:l,chainl:function(a,c,d){return b.optional(c,l(a,d))},chainr1:m,chainr:function(a,c,d){return b.optional(c,m(a,d))}}});
