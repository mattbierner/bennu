...
*/define(["require", "exports", "nu-stream/stream", "seshet"], (function(require, exports, stream, seshat) {
    ...
    var Tail, trampoline, ParserError, ParseError, MultipleError, UnknownError, UnexpectError, ExpectError,
            ...
            sequencea, sequence, empty, either, concat, choices, choicea, choice, optional, expected, eager,
            binds, cons, append, enumerations, enumerationa, enumeration, many, many1, memo, token, anyToken,
            eof, exec, parseState, parseStream, parse, runState, runStream, run, testState, testStream, test,
            NIL = stream["NIL"],
        first = stream["first"],
    ...
    (label = (function(name, p) {
        return (p.run.hasOwnProperty("displayName") ? label(name, new(Parser)(unparser.bind(null, p))) :
    ...
    (attempt = (function(p3) {
        return new(Parser)((function(state, m, cok, cerr, eok, eerr) {
            ...
            return unparser(p3, state, Memoer.pushWindow(m, state.position), (function(x1, s,
                m0) {
    ...
    (memo = (function(p3) {
        return new(Parser)((function(state, m, cok, cerr, eok, eerr) {
            ...
            return unparser(p3, state, m, (function(x9, pstate, pm) {
                return cok(x9, pstate, Memoer.update(pm, position, key, ["cok", x9,
                    pstate
                ]));
            }), (function(x9, pstate, pm) {
                return cerr(x9, pstate, Memoer.update(pm, position, key, ["cerr", x9,
                    pstate
                ]));
            }), (function(x9, pstate, pm) {
                return eok(x9, pstate, Memoer.update(pm, position, key, ["eok", x9,
                    pstate
                ]));
            }), (function(x9, pstate, pm) {
                return eerr(x9, pstate, Memoer.update(pm, position, key, ["eerr", x9,
                    pstate
                ]));
            }));
        }));
    ...
    (token = (function(consume, onErr) {
        ...
        return new(Parser)((function(s, m, cok, cerr, eok, eerr) {
            ...
            return (s.isEmpty() ? eerr(errorHandler(s.position, null), s, m) : ((tok = s.first()), (
                consume(tok) ? ((pcok = (function(x8, s0, m0) {
