...
", Expected:"+this.expected+" Found:"+(this.found?this.found:"end of input")}});var i,n=function(b){var a=b.valueOf();return function(b){return a===b.valueOf()}};i=function(b,a){return c.token(n(b),a)};var l=function(b){return i(b,k(b))},p=function(b,a,d,e){return c.next(i(a,function(b,c){return new g(b,e,d,a,c)}),b)},q=function(b,a){b[a]=b[a]||{};return b[a]},r=function(b,a){j(a,q,b)[""]=null;return b},s=function a(d,e){return c.choicea(Object.keys(d).sort().reverse().map(function(f){return 0===
