("undefined"!==typeof define?define:function(r){parse=r()})(function(){function r(a){return function(){throw a;}}function B(a){return k(function(b){return a===b.toString()})}function k(a){return function(b,f,d,c,j){d=b.c;return b.input?(c=b.input.h(),a(c)?f(c,C(b.input.i(),l.e(d,c))):j(new s(d,"token:'"+c+"'"))):j(new s(d,"end of input"))}}function M(){throw Error("Many parser applied to a parser that accepts an empty string");}function t(a,b){return m(a,p(q,D.bind([b])))}function u(a,b){return function(f,
