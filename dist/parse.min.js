...
"ParseError";Object.defineProperties(h.prototype,{message:{configurable:!0,get:function(){return"At position:"+this.pos+" "+this.errorMessage}},errorMessage:{configurable:!0,get:function(){return void 0===this._msg?"":this._msg}}});var x=function(a){h.call(this,a[0].pos);this.errors=a};x.prototype=new h;x.prototype.constructor=x;x.prototype.name="MultipleError";Object.defineProperties(x.prototype,{errorMessage:{get:function(){return"["+K.call(this.errors,function(a){return a.message}).join(", ")+
