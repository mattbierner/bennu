...
b,c)}},fa=j(A(function(a){return a})),K=function(a){return function(b,c,d,f,e){b=a(b);return e(b,b,c)}},ga=j(A(function(a){return a.userState})),L=function(a){return function(b,c,d,f,e){b=b.setUserState(a(b.userState));return e(b,b,c)}},ha=j(A(function(a){return a.position})),ia=j(A(function(a){return a.input})),S=function(a){return function(b,c,d,f,e,g){return m(a,[b,c,d,g,e,g])}},B=function(a,b){return v(a,j(b))},w=function(a){return function(b,c){return function(d,f,e,g,k,h){var ea=d.position;
return m(b,[d,f,e,g,k,function(b,f,i){return m(c,[d,i,e,g,k,function(c,e,f){return h(a(ea,b,c),d,f)}])}])}}},M=w(function(a,b,c){return new n(a,[b,c])}),ja=w(function(a,b,c){return new z(a,b,c)}),ka=function(a,b){return ja(b,a)},la=function(a,b,c,d,f,e){return e(new n(a.position,[]),a,b)},T=function(a,b){return M(a,u(b))},D=u(i.end),w=function(a){return function(b,c){return v(b,function(b){return v(c,function(c){return u(a(b,c))})})}},E=function(a){return T(a,i.end)},x=w(i.cons),U=w(i.append),ma=
function(a,b){return x(b,a)},N,na=function(){throw new y("Many parser applied to a parser that accepts an empty string");};N=function(a){var b=function(b,d,f,e,g,k){return m(a,[b,d,f,e,na,k])};return C(function(a){return E(x(b,a))})};var O=function(a,b){return 0>=a?D:x(b,O(a-1,b))},V=function(a,b){return 0>=a?D:E(x(b,V(a-1,b)))},W=function(a,b){return C(function(c){return x(b,M(S(B(a,c)),D))})},F,oa=function(a,b){return new t(a,null===b?"end of input":b)};F=function(a,b){b=b||oa;return function(c,
d,f,e,g,k){e=c.position;return(g=c.input)?(g=i.first(g),a(g)?f(g,c.next(g),d):k(b(e,g),c,d)):k(b(e,null),c,d)}};var w=j(F(j(!0))),X=function(a,b){return F(H(a,b))},pa=function(a,b){return B(b,a)},Y=function(a,b,c,d,f,e,g){for(a=a(b,c,d,f,e,g);a&&a._next;)a=a[0].apply(void 0,a[1]);return a()},Z=function(a,b){return function(c,d,f){return Y(c,d,f||null,a,b,a,b)}},G=Z(j,function(a){return function(){throw a;}}),$=function(a,b,c){return G(a,new l(b,new q(0),c||null))},aa=function(a,b){var c=E(v(a,function(a,
b,e){return u(i.memoStream(a,H(G,c,b,e)))}));return G(c,b)},ba=function(a,b,c){return aa(a,new l(b,new q(0),c))},ca=Z(j(j(!0)),j(j(!1))),da=function(a,b,c){return ca(a,new l(b,new q(0),c))};return{ParserError:y,ParseError:h,MultipleError:n,UnknownError:s,UnexpectError:t,ExpectError:r,ParserState:l,Position:q,rec:C,Parser:I,RecParser:function(a,b){return I(a,C(b))},always:u,never:J,bind:v,binda:function(a,b){return v(a,function(a){return b.apply(void 0,i.toArray(a))})},eof:function(){return function(a,
b,c,d,f,e){return i.isEmpty(a.input)?f(i.end,a,b):e(new r(a.position,"end of input",i.first(a.input)),a,b)}},extract:A,getParserState:fa,setParserState:function(a){return K(j(a))},modifyParserState:K,getState:ga,setState:function(a){return L(j(a))},modifyState:L,getInput:ia,setInput:function(a){return L(function(b){return b.setInput(a)})},getPosition:ha,setPosition:function(a){return K(function(b){return b.setPosition(a)})},attempt:S,lookahead:function(a){return function(b,c,d,f,e,g){return m(a,[b,
c,function(a,c,d){return e(a,b,d)},f,e,g])}},next:B,either:M,choice:function(){return 0===arguments.length?J():Q.call(arguments,ka,la)},optional:T,expected:function(a,b){return function(c,d,f,e,g,k){return b(c,d,f,e,g,function(b,c,d){return k(new r(c.position,a),c,d)})}},cons:x,append:U,sequence:function(){return Q.call(arguments,ma,D)},many:N,many1:function(a){return x(a,N(a))},times:O,betweenTimes:function(a,b,c){return b<a?J:U(O(a,c),V(b-a,c))},between:function(a,b,c){return B(a,v(c,function(a){return B(b,
u(a))}))},sepBy1:W,sepBy:function(a,b){return E(W(a,b))},token:F,anyToken:w,character:function(a,b){return X(b||R,a)},string:function(a,b){return P.call(a,H(X,b||R)).reduceRight(pa,u(a))},backtrack:function(a){return function(b,c,d,f,e,g){return m(a,[b,c,function(a,b){return d(a,b,c)},function(a,b){return f(a,b,c)},function(a,b){return e(a,b,c)},function(a,b){return g(a,b,c)}])}},memo:function(a){var b=a.parserId||Math.random();return function(c,d,f,e,g,h){var i=p.lookup(d,b,c);return i?m(i,[c,d,
f,e,g,h]):m(a,[c,d,function(a,d,e){return f(a,d,p.update(e,b,c,function(b,c,e){return e(a,d,c)}))},function(a,d,f){return e(a,d,p.update(f,b,c,function(b,c,e,f){return f(a,d,c)}))},function(a,d,e){return g(a,d,p.update(e,b,c,function(b,c,e,f,g){return g(a,d,c)}))},function(a,e,f){return h(a,e,p.update(d,b,c,function(b,c,d,g,h,i){return i(a,e,f)}))}])}},exec:Y,runState:G,runStream:$,run:function(a,b,c){return $(a,i.from(b),c)},runManyState:aa,runManyStream:ba,runMany:function(a,b,c){return ba(a,i.from(b),
c)},testState:ca,testStream:da,test:function(a,b,c){return da(a,i.from(b),c)}}});
