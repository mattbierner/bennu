define(["nu/stream"],function(i){var J=Array.prototype.map,K=Array.prototype.reduceRight,w=function(a){return a.bind.apply(a,arguments)},p=function(a){return function(){return a}},L=function(a,b){return a===b},j=function(a,b){var c=[a,b];c._next=!0;return c},l=function(a,b,c,d){this.id=a;this.val=b;this.state=c;this.delegate=d};l.lookup=function(a,b,c){for(;a;a=a.delegate)if(a.id===b&&a.state.eq(c))return a.val;return null};l.update=function(a,b,c,d){return new l(b,c,d,a)};var m=function(a){this.index=
...
d,h){return j(b,[c,h,f,e,g,function(b,d,e){return k(new x(a,b),c,e)}])}])}},ba=function(a,b){return A(b,a)},P=function(a,b){return A(a,t(b))},B=t(i.end),C=function(a,b,c){return u(b,function(b){return u(c,function(c){return t(a(b,c))})})},D=function(a){return P(a,i.end)},v=w(C,i.cons),Q=w(C,i.append),ca=function(a,b){return v(b,a)},H,da=function(){throw Error("Many parser applied to a parser that accepts an empty string");};H=function(a){var b=function(b,d,f,e,g,k){return j(a,[b,d,f,e,da,k])};return z(function(a){return D(v(b,
