define(["stream/stream"],function(i){var J=Array.prototype.map,K=Array.prototype.reduceRight,w=function(a){return 1===arguments.length?a:a.bind.apply(a,arguments)},p=function(a){return function(){return a}},L=function(a,b){return a===b},j=function(a,b){var c=[a,b];c._next=!0;return c},l=function(a,b,c,d){this.id=a;this.val=b;this.state=c;this.delegate=d};l.lookup=function(a,b,c){for(;a;a=a.delegate)if(a.id===b&&a.state.eq(c))return a.val;return null};l.update=function(a,b,c,d){return new l(b,c,d,
