define(["require","exports","nu/stream","seshat"],function(ca,c,k,F){var p,K,t,d,l,u,v,r,h,j,G,n,w,H,q,A,L,x,da,M,ea,I,N,O,P,Q,y,R,B,s,S,T,U,fa,e,V,C,W,X,Y,Z,$;s=k.end;var ja=k.first,ka=k.isEmpty,la=k.rest,ma=Function.prototype.call.bind(Array.prototype.map),aa=Function.prototype.call.bind(Array.prototype.reduceRight),ba=function(){return arguments},z=function(a){return function(){return a}},ga=Math.random;p=function(a,b){var g=[a,b];g._next=!0;return g};K=function(a){for(;a&&a._next;)a=a[0].apply(void 0,
...
{get:function(){return"Expected:"+this.expected+(this.found?" Found:"+this.found:"")}});G=function(a){var b=a(function(){return b.apply(this,arguments)});return b};n=function(a,b){return b.hasOwnProperty("parserId")?n(a,function(){return b.apply(this,arguments)}):Object.defineProperties(b,{displayName:{value:a,writable:!1},parserId:{value:ga(),writable:!1}})};w=function(a){return function(b,g,c,f,i){return i(a,b,g)}};H=function(a){return function(b,g,c,f,i,e){return e(a,b,g)}};q=function(a,b){return function(g,
c,f,i,e,m){return p(a,[g,c,function(a,g,c){return p(b(a,g,c),[g,c,f,i,f,i])},i,function(a,g,c){return p(b(a,g,c),[g,c,f,i,e,m])},m])}};x=function(a){return function(b,g,c,f,i){b=a(b);return i(b,b,g)}};L=n("Get Parser State",x(function(a){return a}));A=function(a){return function(b,c,D,f,i){return i(a(b),b,c)}};M=function(a){return x(function(b){return b.setUserState(a(b.userState))})};da=n("Get State",A(function(a){return a.userState}));I=n("Get Position",A(function(a){return a.position}));ea=n("Get Input",
A(function(a){return a.input}));var ha=function(a){return q(I,function(b){return H(a(b))})};var oa=w(s),ca=n("EOF",q(L,function(a){return a.isEmpty()?oa:ha(function(b){return new r(b,"end of input",a.first())})}));N=function(a,b){return q(a,z(b))};var pa=function(a,b){return N(b,a)};O=function(a){return aa(a,pa)};y=function(a){return function(b,c){return function(D,f,i,e,m,na){var J=D.position;return p(b,[D,f,i,e,m,function(b,f,d){return p(c,[D,d,i,e,m,function(c,g,f){return na(a(J,b,c),D,f)}])}])}}};
P=y(function(a,b,c){return new l(a,[b,c])});var qa=y(function(a,b,c){return new E(a,b,c)}),ra=function(a,b){return qa(b,a)},sa=q(I,function(a){return H(new l(a,[]))});Q=function(a){if(!a.length)throw new t("choice called no parsers");return aa(a,ra,sa)};y=function(a,b){return P(b,w(a))};var ta=w(s),ua=y.bind(null,s);s=function(a){return function(b,c){return q(b,function(b){return q(c,function(c){return w(a(b,c))})})}};var va=function(a){return w(k.toArray(a))};R=function(a){return q(a,va)};B=s(k.cons);
