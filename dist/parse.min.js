...
function e(a){return 1===arguments.length?a:a.bind.apply(a,arguments)}var S=Array.prototype.concat,U=Array.prototype.join,V=Array.prototype.map,W=Array.prototype.reduce,X=Array.prototype.reduceRight,Y=Function.prototype.apply,i=e(e,P);w.prototype.j=function(){return this.d[this.b]};w.prototype.l=function(){return this.b+1===this.length?null:new w(this.d,this.b+1,this.length)};var j;j=function(a,b){return Object.freeze({line:a,column:b,toString:T})};j.k=function(a,b){return"\n"===b?j(a.c+1,1):j(a.c,
a.g+1)};h.prototype=Error();Object.defineProperties(h.prototype,{message:{get:function(){var a=this.m;return"At position:"+this.a+" ["+(a?U.call(a,", "):"")+"]"}},messages:{get:function(){return this.e}}});y.prototype=new h;Object.defineProperty(y.prototype,"messages",{get:function(){return[this.h.n,this.i.message]}});B.prototype=new h;t.prototype=new h;A.prototype=new h;var K=L(i,function(a){return function(){throw a;}}),Z=L(i(i(!0)),i(i(!1))),C=i(function(a,b,d,f,c){return c(new B(a.a))}),$=i(function(a,
b,d,f,c){return!a.input?f(null,a):c(new A(a.a,"end of input"))}),aa=e(I,P),m=q([]),u;u=function(a){function b(b,f,c,e,g){return k(a,[b,f,c,Q,g])}return z(function(a){return F(g(b,e(l,a)))})};var ba=x(i(!0));return{ParseError:h,UnknownError:B,UnexpectError:t,ExpectError:A,InputState:s,Position:j,Parser:M,RecParser:z,NamedRecParser:function(a,b){return M(a,z(b))},runParser:K,runStream:J,run:function(a,b){return J(a,N(b))},test:function(a,b){return Z(a,s(N(b),j(1,1)))},always:q,never:C,bind:g,binda:function(a,
b){return g(a,Y.bind(b,void 0))},eof:$,extract:I,examine:aa,attempt:G,lookahead:function(a){return function(b,d,e,c,g){return k(a,[b,function(a){return c(a,b)},e,c,g])}},next:n,either:p,sequence:function(){return X.call(arguments,R,m)},many:u,many1:function(a){return g(a,e(l,u(a)))},times:v,optional:function(a){return p(v(1,a),m)},betweenTimes:function(a,b,d){return b<a?C:g(v(a,d),e(H,E(b-a,d)))},between:function(a,b,d){var f=e(n,b);return n(a,g(d,function(){return f(q.apply(void 0,arguments))}))},
sepBy1:D,sepBy:function(a,b){return p(D(a,b),m)},choice:function(){return 0===arguments.length?C:W.call(arguments,p)},token:x,anyToken:ba,character:function(a,b){return r(b||O,a)},string:function(a,b){return V.call(a,e(r,b||O)).concat(q(a)).reduce(n)}}});
