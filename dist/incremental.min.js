...
this.state.setUserState(a))};l=function(a,b){if(a.done||D(b))return a;for(var d=a.addChunk(b),c=t(d.k(b));c instanceof u&&d.hasChunk(c.chunk);)c=t(c.k(d.getChunk(c.chunk)));return c instanceof u?new h(!1,c.k,d.chunks):c};m=function(a){return a.done?a.k():m(t(a.k(k)))};j=function(a,b,d,c){var e;var f=function(a,b){return new h(!0,d.bind(null,a,b))},i=function(a,b){return new h(!0,c.bind(null,a,b))};e=b.isEmpty()?new h(!1,function(c){return C(a,new g(0,b.setInput(c)),f,i)},[]):l(j(a,b.setInput(k),d,
